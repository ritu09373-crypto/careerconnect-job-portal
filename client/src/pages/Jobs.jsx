...
function Jobs() {
  ...
  return (
    <section className="page">
      ...
      <p className="lead">
        Search active roles from growing teams and apply when you are ready.
      </p>
      ...
      {filteredJobs.length ? (
        <div className="job-list">
          {filteredJobs.map((job) => (
            <article className="card job-card" key={job._id}>
              ...
              <button className="button" type="button" onClick={() => navigate(`/jobs/${job._id}`)}>
                View role
              </button>
            </article>
          ))}
        ...
        <div className="empty card">
          ...
          <p>Try removing a filter or searching for a different skill.</p>
        </div>
      )}
    </section>
  );
